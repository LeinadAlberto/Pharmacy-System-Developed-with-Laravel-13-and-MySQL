...
@section('content')
    ...
    <div class="container-fluid px-0">
        <div class="row g-0 min-vh-100">
            <div class="col-12 col-md-6 auth-left-col d-flex align-items-center justify-content-center py-0 py-md-5">
                <div class="login-panel w-100 px-4 px-sm-5">
                    <div class="mb-5">
                        ...
                        <h1 class="display-5 fw-bold mb-3">Log in.</h1>
                        <p class="text-muted">Log in with your data that you entered during registration.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                            <label for="email" class="form-label text-muted">Username</label>
                            <div class="input-group shadow-sm rounded-3 overflow-hidden">
                                <span class="input-group-text bg-white border-end-0 py-3">
                                    <i class="bi bi-person"></i>
                                </span>
                                <input id="email" type="email" class="form-control border-start-0 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Username">
                            </div>
                            @error('email')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group shadow-sm rounded-3 overflow-hidden">
                                ...
                                <input id="password" type="password" class="form-control border-start-0 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Password">
                            </div>
                            @error('password')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
            ...
            <div class="col-md-6 d-none d-md-flex auth-right-col align-items-center justify-content-center login-right"></div>
